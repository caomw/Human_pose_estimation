...
#define TRAINING_DIR "/media/sda1/Study/Data/Human_pose_estimation/PDT/PDT2EVAL/ordered_by_diversity/ordered_sequence_mgs/"
#define SAVE_DIR "/media/sda1/Study/Data/Human_pose_estimation/Result_PDT/"
...
//F1D1: 1400, F1D2: 1632, F1D3: 910, F1D4: 1218 -> 5160(model 0)
//F2D1: 1562, F2D2: 1375, F2D3: 1404, F2D4: 1403 -> 5744(model 1)
//M1D1: 996, M1D2: 1412, M1D3: 1193, M1D4: 1412 -> 5013(model 2)
//M2D1: 1094, M2D2: 1050, M2D3: 1174, M2D4: 1278 -> 4596(model 3)
//M3D1: 1402, M3D2: 2045, M3D3: 1518, M3D4: 1523 -> 6488(model 4)
#define TRAIN_FRAME_NUM 8000
#define POINT_MATCHING_FRAME_NUM 300
#define TEST_FRAME_NUM 300
#define TEST_MODEL_1 2
#define TEST_MODEL_2 3
#define TEST_MODEL_3 4
	...
	for (int test_tree_number = 1; test_tree_number <= tree_head.size(); test_tree_number+=1)
	{
		...
		for (int f = 0; f < TEST_FRAME_NUM; f++)
		{
            ...
            */
			...
			//draw joint
			for (int joint_index = 0; joint_index < JOINT_NUMBER; joint_index++)
				if(joint_index != TRSO && joint_index != L_HIPS && joint_index != R_HIPS && joint_index != BLLY)
